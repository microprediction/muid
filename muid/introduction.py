...
EXPLANATION = ["Hey thanks for giving this a spin ",
             ...
             "  ",
              ...
              "Don't worry we aren't going to burn the Earth either way",
               "Just generate you a good non de plume",
            ...
            "   ",
            "Hey maybe you took the time to read the docs https://microprediction.github.io/microprediction/",
            "That's another joke",
            "Obviously",
            "Nobody reads docs",
            "   ",
            ...
            "Here it is just a primitive throttling mechanism",
             ...
             "Which usually works",  
            "  ",
            "I'm not saying you should hoard MUIDs by the way ",
            ...
            "Like 13 and 14 digit MUIDs for example",
            ...
            "   ",
            "The prediction web is a profesy, though there is an oracle api.microprediction.org",
            "It is far from perfect.",
            "But actually one manager has been using it for a while",
             "And it has processed about a billion predictions", 
            "   ",
